...
- [`../../../.ai/skills/gc-dev-setup/SKILL.md`](../../../.ai/skills/gc-dev-setup/SKILL.md)

## 边界说明

- 构建与打包规则以 `spec/delivery/build-and-package.md` 为准
- 测试规则以 `spec/foundations/testing-guide.md` 和 `spec/workflows/test-workflow.md` 为准
- 本文件是 Claude 适配层，不是跨 AI 的唯一环境初始化 skill 来源
