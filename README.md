...
```bash
# 从 Releases 下载 .deb 包
wget https://gitcode.com/gitcode-cli/cli/releases/download/v0.2.4/gc_0.2.4_amd64.deb

# 安装
sudo dpkg -i gc_0.2.4_amd64.deb
```
...
```bash
# 从 Releases 下载 .rpm 包
wget https://gitcode.com/gitcode-cli/cli/releases/download/v0.2.4/gc-0.2.4-1.x86_64.rpm

# 安装
sudo rpm -i gc-0.2.4-1.x86_64.rpm
```
