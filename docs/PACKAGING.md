...
```
dist/
├── gitcode_cli-0.3.2-py3-none-any.whl
└── gitcode_cli-0.3.2.tar.gz
```
...
# 安装 wheel
pip install dist/gitcode_cli-0.3.2-py3-none-any.whl
...
```bash
# 下载并安装
wget https://gitcode.com/owner/repo/releases/download/v0.3.2/gc_0.3.2_amd64.deb
...
```bash
# 下载并安装
wget https://gitcode.com/owner/repo/releases/download/v0.3.2/gc-0.3.2-1.x86_64.rpm
sudo rpm -i gc-0.3.2-1.x86_64.rpm

# 或使用 gc 命令下载
gc release download v0.3.0 gc-0.3.2-1.x86_64.rpm -R owner/repo
sudo rpm -i gc-0.3.2-1.x86_64.rpm
```
