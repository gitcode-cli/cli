...
func NewCmdList(f *cmdutil.Factory, runF func(*ListOptions) error) *cobra.Command {
	...
	cmdutil.SetFlagEnumOrWarn(cmd, "state", "open", "closed", "merged", "all")
	...
	cmdutil.SetFlagEnumOrWarn(cmd, "sort", "created", "updated", "popularity", "long-running")
	cmd.Flags().StringVar(&opts.Direction, "direction", "", "Sort direction (asc/desc)")
	cmdutil.SetFlagEnumOrWarn(cmd, "direction", "asc", "desc")
