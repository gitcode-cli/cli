...
| 9 | 远端 CI | 通过 GitCode 原生 Linux CI；有 GitHub 镜像 PR 时同时通过跨平台 CI | [CI 工作流规范](../delivery/ci-workflows.md) | ✅ 可跳过 |
...
CI 因环境原因（如 GitCode Actions 或 GitHub 镜像仓不可达）无法执行时，必须在自检中明确记录原因。
